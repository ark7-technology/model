...
Full API reference: [StrictConfigOptions](https://ark7-technology.github.io/model/interfaces/StrictConfigOptions.html)
...
| `toObject` | [`DocumentToObjectOptions`](https://ark7-technology.github.io/model/interfaces/DocumentToObjectOptions.html) | Default options applied when calling `.toObject()`. |
| `toJSON` | [`DocumentToObjectOptions`](https://ark7-technology.github.io/model/interfaces/DocumentToObjectOptions.html) | Default options applied when calling `.toJSON()`. |
